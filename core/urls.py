...
# Importing all views created for the Bike Rental System
...
urlpatterns = [
    ...
    # 4. Password Reset Flow (Essential for Student Self-Service)
    path('password-reset/', 
...
# 5. Media & Static File Routing
# This allows the "Live Photos" to be served and viewed in the Admin panel
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)
else:
    # On Render/Production, this ensures media is still accessible
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)
